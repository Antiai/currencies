...
const DESKTOP_FONTS: IFonts = {
  ...
  tab: getFont('normal', 'tab', 'normal', 'desktop'),
  tableHeadCell: getFont('normal', 'tableHeadCell', 'normal', 'desktop'),
...
const MOBILE_FONTS: IFonts = {
  ...
  tab: getFont('normal', 'tab', 'normal', 'mobile'),
  tableHeadCell: getFont('normal', 'tableHeadCell', 'normal', 'mobile'),
